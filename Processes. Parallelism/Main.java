...
final class JavaProcess {
    private JavaProcess() {}
    public static Process exec(Class klass) throws IOException, InterruptedException {
...
public class Main {
    ...
    public static void main(String[] argv) {
        ...
        try {
            ...
            Process processf = JavaProcess.exec(MainF.class);
            ...
            Process processg = JavaProcess.exec(MainG.class);
            ...
            boolean f = Boolean.parseBoolean(tofOutput.toString().trim());
            boolean g = Boolean.parseBoolean(togOutput.toString().trim());
            ...
            System.out.println(e.toString() + " asadsdawe");
        }
    }
}